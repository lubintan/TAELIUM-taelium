...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/taelium.manifest.mf", Taelium.class.getCanonicalName(), "./lib");
        ...
        manifestGenerator.generate("./resource/taeliumservice.manifest.mf", serviceClassName, "./lib");
    }
