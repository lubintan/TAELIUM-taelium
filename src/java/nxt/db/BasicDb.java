...
public class BasicDb {
    ...
    }// end DbProperties final static class.
// final means can only assign to the variable ONCE
    ...
    public BasicDb(DbProperties dbProperties) {	//Constructor!
    ...
    public void init(DbVersion dbVersion) {
        ...
        try (Connection con = cp.getConnection();
             Statement stmt = con.createStatement()) //try with resources: stuff in parentheses will
        //auto close if try block fails, without needing a finally block.        
        {
    ...
    protected Connection getPooledConnection() throws SQLException {
        ...
        if (activeConnections > maxActiveConnections) { // merely triggers logger to log pool size.
